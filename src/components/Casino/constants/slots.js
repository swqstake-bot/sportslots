...
export const PROVIDERS = {
  ...
  'meta-gaming': { id: 'meta-gaming', name: 'Meta Gaming', impl: 'web' },
  metagaming: { id: 'metagaming', name: 'Meta Gaming', impl: 'web' },
  'print-studios': { id: 'print-studios', name: 'Print Studios', impl: 'web' },
  printstudios: { id: 'printstudios', name: 'Print Studios', impl: 'web' },
