...
export function placeBaccaratBet(params: { currency: string; player?: number; banker?: number; tie?: number; identifier?: string }): Promise<{ iid?: string; id?: string; betApiId?: string; payout?: number; payoutMultiplier?: number; amount?: number; game?: string; state?: Record<string, unknown> } | null>
